...
const OUTILS = [
  ...
  },
  {
    ...
    declaration: {
      ...
      description: "Consulte le catalogue des véhicules du logiciel (mêmes listes déroulantes que le dossier véhicule) : marques offertes pour une année, modèles d'une marque (pour une année), ou versions d'un modèle.",
      parameters: {
        type: "OBJECT",
        properties: {
