...
const COLONNES = [
  { cle: "numero", label: "No client", largeur: 75, align: "left" },
  { cle: "nom", label: "Nom", largeur: 140, align: "left" },
  { cle: "telephone", label: "Téléphone", largeur: 90, align: "left" },
  { cle: "courriel", label: "Courriel", largeur: 140, align: "left" },
  { cle: "ville", label: "Ville", largeur: 87, align: "left" },
];
...
function genererPdfRapportClients(clients, nomEntreprise) {
  return new Promise((resolve, reject) => {
    ...
    for (const c of clients) {
      ...
      const yLigne = doc.y;
      const valeurs = { numero: c.numero || "—", nom: c.nom, telephone: c.telephone || "—", courriel: c.courriel || "—", ville: c.ville || "—" };
      COLONNES.forEach((col, i) => {
