...
// Hiérarchie numérique des rôles employés (utilisée pour empêcher un employé
// de modifier la fiche de quelqu'un d'un niveau de sécurité supérieur au
// sien, ex: une secrétaire réinitialisant le mot de passe d'un gérant).
// DEVELOPPEUR n'y figure pas : ce n'est jamais un rôle stocké sur un User,
// voir estGerantOuDev.
