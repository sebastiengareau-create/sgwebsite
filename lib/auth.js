...
// Hiérarchie des rôles employés (le développeur est à part, toujours
// au-dessus — voir estGerantOuDev) : sert à empêcher un employé avec accès
// délégué à "employes" (ex: une secrétaire) de s'assigner, ou d'assigner à
// quelqu'un d'autre, un niveau de sécurité plus élevé que le sien — ou de
// toucher au rôle de quelqu'un dont le niveau actuel dépasse déjà le sien.
const NIVEAU_ROLE = { MECANICIEN: 1, SECRETAIRE: 2, GERANT: 3 };
