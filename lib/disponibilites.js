...
// Même semaine type que l'horaire de paie par défaut (lib/paie.js) :
// lun–jeu 8 h, ven 5 h (dîner exclu côté paie), fin de semaine fermé.
const DEFAUTS_OUVERTURE = {
  lun: { ouverture: "08:00", fermeture: "17:00" },
  mar: { ouverture: "08:00", fermeture: "17:00" },
  mer: { ouverture: "08:00", fermeture: "17:00" },
  jeu: { ouverture: "08:00", fermeture: "17:00" },
  ven: { ouverture: "08:00", fermeture: "13:00" },
  sam: null,
  dim: null,
};
...
async function chargerReglagesDisponibilites() {
  ...
  const parametres = await prisma.parametre.findMany({ where: { cle: { in: cles } } });
