...
export default async function ComptesAPayer() {
  ...
  const [fournisseurs, categories, comptesDepense, depenses, parametres] = await Promise.all([
    ...
    prisma.depense.findMany({ include: { fournisseur: true, categorieDepense: true }, orderBy: { dateFacture: "desc" }, take: 50 }),
