...
const MODELES = [
  "user", "client", "vehicule", "tacheInterne", "compte", "compteTresorerie", "categorieInventaire",
  "bonTravail", "probleme", "photo", "piece", "mouvementInventaire", "historiquePiece", "pieceUtilisee",
