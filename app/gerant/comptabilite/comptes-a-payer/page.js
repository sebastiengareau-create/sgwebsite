...
export default async function ComptesAPayer() {
  ...
  const [fournisseurs, categories, comptesDepense, depenses, parametres, comptesTresorerie, pieces] = await Promise.all([
  ...
  return (
    <div>
      ...
      <ComptesAPayerClient
        ...
        comptesTresorerie={comptesTresorerie} pieces={pieces}
      />
    </div>
  );
}
