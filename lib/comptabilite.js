...
async function posterFactureEmise(bon, facture, creePar) {
  ...
  // Revenu par catégorie de tâche — main-d'œuvre sur les heures poinçonnées,
  // les autres postes (remorquage, alignement, entreposage, autre) sur leur
  // ligne de facturation manuelle (prix unitaire × quantité)
  ...
  for (const pr of bon.problemes) {
    ...
    mainOeuvreParCategorie[cat] = (mainOeuvreParCategorie[cat] || 0) + montant;
  }
